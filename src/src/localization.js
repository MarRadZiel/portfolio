document.addEventListener('DOMContentLoaded', function () {
    const translations = {
        en: {
            ...
            s_prof_exp_vescom_ruvre_p_1: "My primary task was developing a project called RUVRE, designed to provide real-time visualization of architectural changes for the client.",
            ...
            s_prof_exp_vescom_ruvre_p_2_3: "a multiplatform client application created in Unity compatible with Android, Windows, VR headsets (both desktop and standalone) and featuring AR mode,",
            ...
            s_prof_exp_vescom_other_p_1_1: "creating a VR demo application for a client. It allows taking a tour around an office building and displaying various type of data in a form od e.g. 3D charts and heatmaps. It also contains the model mode in which the scene is presented as a model which user can rotate, scale and move,",
            s_prof_exp_vescom_other_p_1_2: "creating a VR application as an interactive display for the client’s hardware products. The application provides 3DOF experience. It allows to select products from the shelf and show information about them,",
            s_prof_exp_vescom_other_p_1_3: "updating and improving an already published Android game. I’ve also added third playable level to the game using existing and unfinished assets,",
            s_prof_exp_vescom_other_p_1_4: "updating and modifying VR game made for Oculus GO to work with modern headsets,",
            s_prof_exp_vescom_other_p_1_5: "adding a VR support to existing applications (both Unity and Unreal Engine),",
            s_prof_exp_vescom_other_p_1_6: 'prototyping an AR application using <a href="https://developers.google.com/ml-kit">ML Kit</a>,',
            s_prof_exp_vescom_other_p_1_7: "helping with the development of a PHP web service using Yii2 framework.",
            ...
            s_proj_modal_witchcraft_p_3: 'The game took first place in <span class="tooltip"><a href="https://gry.it.p.lodz.pl/main/index.php/pl/okonkursie/poprzednie-edycje/edycja-2017" target="_blank">IX ZTGK</a><span class="tooltiptext">(Team Game Development Competition)</span></span> in "Development" category and was rewarded by Teyon.',
            ...
            s_proj_modal_hnb_p_3: 'Project qualified for the final three in the "Game Design" category of <span class="tooltip"><a href="https://gry.it.p.lodz.pl/main/index.php/pl/okonkursie/poprzednie-edycje/edycja-2017" target="_blank">IX ZTGK</a><span class="tooltiptext">(Team Game Development Competition)</span></span>.<br/>The game was then developed further with help of the Lodz University of Technology POWER project. It took part in the <a href="https://arp.pl/pl/aktualnosci/arp-games-zainwestowalo-0-5-mln-w-gry-wideo" target="_blank">ARP Games</a> acceleration program and qualified for the investment stage.',
            ...
            s_proj_modal_cutefall_p_3: 'The project was developed for <span class="tooltip"><a href="https://gry.it.p.lodz.pl/main/index.php/pl/okonkursie/poprzednie-edycje/edycja-2018" target="_blank">X ZTGK</a><span class="tooltiptext">(Team Game Development Competition)</span></span>. It qualified for the finals in the "Mobile Games" category.',
            ...
            s_proj_modal_catapult_p_3: 'The project was developed for <span class="tooltip"><a href="https://gry.it.p.lodz.pl/main/index.php/pl/okonkursie/poprzednie-edycje/edycja-2018" target="_blank">X ZTGK</a><span class="tooltiptext">(Team Game Development Competition)</span></span>. It qualified for final three in the "Virtual Environments" category.',
            ...
            s_proj_modal_museumvr_p_3: 'The project qualified for the finals in <span class="tooltip"><a href="https://gry.it.p.lodz.pl/main/index.php/pl/okonkursie/poprzednie-edycje/edycja-2018" target="_blank">X ZTGK</a><span class="tooltiptext">(Team Game Development Competition)</span></span> "Virtual Environments" category.',
            ...
            s_proj_modal_impstr_p_3: 'The project qualified for the finals in <span class="tooltip"><a href="https://gry.it.p.lodz.pl/main/index.php/pl/okonkursie/poprzednie-edycje/edycja-2019" target="_blank">XI ZTGK</a><span class="tooltiptext">(Team Game Development Competition)</span></span> "Game Design" category and received an invitation for <a href="https://conference.digitaldragons.pl/indie-zone-old/indie-showcase/">Indie Showcase</a> during <a href="https://digitaldragons.pl/">Digital Dragons</a> 2020.',
        ...
        pl: {
            ...
            s_aboutme_text_p_1: "Jestem programistą, którego pasją jest tworzenie gier i aplikacji multimedialnych. Szczególnie lubię zadania, które wiążą się z tworzeniem narzędzi do uproszczenia procesu rozwijania aplikacji, jak przykładowo rozszerzanie możliwości silnika gier.",
            ...
            s_aboutme_text_p_3: "W swoim wolnym czasie lubię pracować nad osobistymi projektami takimi jak gra zainspirowana Sudoku, którą aktualnie rozwijam. Mając działający prototyp stworzony w Unity, planuję jego dalsze poprawki i wydanie, kiedy zostanie dokończony.",
            ...
            s_prof_exp_vescom_ruvre_p_1: "Moim głównym zadaniem było rozwijanie projektu RUVRE, zaprojektowanego z myślą o dostarczaniu klientowi w czasie rzeczywistym wizualizacji zmian architektonicznych.",
            ...
            s_prof_exp_vescom_ruvre_p_2_3: "wieloplatformowej aplikacji klienckiej stworzonej w Unity, kompatybilnej z systemem Android, Windows, urządzeniami VR (zarówno stacjonarnymi jak i samodzielnymi) oraz posiadającej tryb AR,",
            s_prof_exp_vescom_ruvre_p_2_4: "współdzielonej biblioteki klas używanej przez wszystkie z powyższych.",
            s_prof_exp_vescom_ruvre_p_3: "Projekt pozwalał na konwertowanie danych z istniejącego oprogramowania do naszego formatu wykorzystując plugin oraz wgranie ich na serwer z użyciem stworzonego web serwisu.",
            ...
            s_prof_exp_vescom_other_p_1_1: "stworzenie demonstracyjnej aplikacji VR dla klienta. Pozwalała ona na zwiedzanie biurowca oraz wyświetlanie różnego rodzaju danych w postaci m.in. trójwymiarowych wykresów oraz map ciepła. Zawierała również tryb modelu, w którym scena była przedswationa w formie makiety, którą użytkownik mógł obracać, skalować i przemieszczać,",
            s_prof_exp_vescom_other_p_1_2: "stworzenie aplikacji VR służącej jako interaktywna wystawa produktów sprzętowych klienta. Aplikacja dostarczała doświadczenie 3DOF. Pozwalała na wybranie produktów z półki i wyświetlenie informacji o nich,",
            s_prof_exp_vescom_other_p_1_3: "aktualizacja i poprawa już wydanej gry Android. Dodałem do niej także trzeci grywalny poziom korzystając z istniejących i niedokończonych assetów,",
            s_prof_exp_vescom_other_p_1_4: "aktualizacja i modyfikacja gry VR stworzonej na Oculus GO, tak aby działała ze współczesnymi headset'ami,",
            s_prof_exp_vescom_other_p_1_5: "dodanie wsparcia dla VR do istniejących aplikacji (zarówno w Unity jak i w Unreal Engine),",
            s_prof_exp_vescom_other_p_1_6: 'zaprototypowanie aplikacji AR wykorzystującej <a href="https://developers.google.com/ml-kit">ML Kit</a>,',
            s_prof_exp_vescom_other_p_1_7: "pomoc w rozwijaniu web serwisu PHP korzystającego z framework'u Yii2.",
            ...
            s_proj_modal_witchcraft_p_3: 'Gra zajęła pierwsze miejsce w <span class="tooltip"><a href="https://gry.it.p.lodz.pl/main/index.php/pl/okonkursie/poprzednie-edycje/edycja-2017" target="_blank">IX ZTGK</a><span class="tooltiptext">(Zespołowe Tworzenie Gier Komputerowych)</span></span> w kategorii "Development" i została nagrodzona przez firmę Teyon.',
            ...
            s_proj_modal_hnb_p_2: "Byłem odpowiedzialny m.in. za stworzenie systemu zapisów, zakodowanie obliczania toru lotów wysp oraz dostosowanie modelu kafelka wyspy, na podstawie jego połączeń z innymi kafelkami.",
            s_proj_modal_hnb_p_3: 'Projekt zakwalifikował się do finałowej trójki w kategorii "Game Design" podczas <span class="tooltip"><a href="https://gry.it.p.lodz.pl/main/index.php/pl/okonkursie/poprzednie-edycje/edycja-2017" target="_blank">IX ZTGK</a><span class="tooltiptext">(Zespołowe Tworzenie Gier Komputerowych)</span></span>.<br/>Gra była następnie rozwijana przy wsparciu projektu POWER Politechniki Łódzkiej. Wzięła udział w programie akceleracyjnym <a href="https://arp.pl/pl/aktualnosci/arp-games-zainwestowalo-0-5-mln-w-gry-wideo" target="_blank">ARP Games</a> i zakwalifikowała się do fazy inwestycyjnej.',

            s_proj_modal_cutefall_team: "Zespół: 2 programistów, 1 artystka",
            s_proj_modal_cutefall_p_1: "Gra mobilna o łapaniu spadających zwierząt w bańki o róznych rozmiarach.",
            s_proj_modal_cutefall_p_2: "Byłem odpowiedzialny m.in. za implementację systemu liczenia wyniku i combo.",
            s_proj_modal_cutefall_p_3: 'Projekt został stworzony na potrzeby <span class="tooltip"><a href="https://gry.it.p.lodz.pl/main/index.php/pl/okonkursie/poprzednie-edycje/edycja-2018" target="_blank">X ZTGK</a><span class="tooltiptext">(Zespołowe Tworzenie Gier Komputerowych)</span></span>. Zakwalifikował się do finałów w kategorii "Mobile Games".',
            ...
            s_proj_modal_catapult_p_2: "Byłem odpowiedzialny za większość kodu m.in. zaimplementowałem zachowanie katapulty i napisałem efekty post-procesowe.",
            s_proj_modal_catapult_p_3: 'Projekt był stworzony na potrzeby <span class="tooltip"><a href="https://gry.it.p.lodz.pl/main/index.php/pl/okonkursie/poprzednie-edycje/edycja-2018" target="_blank">X ZTGK</a><span class="tooltiptext">(Zespołowe Tworzenie Gier Komputerowych)</span></span>. Zakwalifikował się do finałowej trójki w kategorii "Virtual Environments".',
            ...
            s_proj_modal_museumvr_p_3: 'Projekt zakwalifikował się do finałów <span class="tooltip"><a href="https://gry.it.p.lodz.pl/main/index.php/pl/okonkursie/poprzednie-edycje/edycja-2018" target="_blank">X ZTGK</a><span class="tooltiptext">(Zespołowe Tworzenie Gier Komputerowych)</span></span> w kategorii "Virtual Environments".',
            ...
            s_proj_modal_impstr_p_3: 'Projekt zakwalifikował się do finałów <span class="tooltip"><a href="https://gry.it.p.lodz.pl/main/index.php/pl/okonkursie/poprzednie-edycje/edycja-2019" target="_blank">XI ZTGK</a><span class="tooltiptext">(Zespołowe Tworzenie Gier Komputerowych)</span></span> w kategorii "Game Design" i otrzymał zaproszenie na <a href="https://conference.digitaldragons.pl/indie-zone-old/indie-showcase/">Indie Showcase</a> podczas <a href="https://digitaldragons.pl/">Digital Dragons</a> 2020.',
            ...
            s_gamejam_modal_mission_p_2: "To był mój pierwszy w pełni zdalny game jam co uczyniło projekt trudnym do rozwijania w tak krótkim czasie, ale ostatecznie byliśmy w stanie stworzyć niemal skończoną grę.",
            ...
            s_gamejam_modal_sacrableu_p_2: "Głównym twist'em jest to, że aby się poruszać, gracze muszą w tym celu naprzemiennie wciskać trigger'y zamiast tradycyjnego joystick'a analogowego.",
