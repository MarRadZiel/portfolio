document.addEventListener('DOMContentLoaded', function () {
    const translations = {
        ...
        pl: {
            ...
            s_prof_exp_vescom_ruvre_p_1: "Moim głównym obowiązkiem było rozwijanie projektu RUVRE, zaprojektowanego z myślą o dostarczaniu klientowi w czasie rzeczywistym wizualizacji zmian architektonicznych.",
